...
SERVER = "&server" INSTALL = "/opt/TKGrid";
...
proc lasr port=10031
   data=vapublic.pdv
   signer="http://&server:7980/SASLASRAuthorization"
    add noclass;
   performance 
      host="&server"
      ;
...
LIBNAME LASRLIB SASIOLA  TAG=VAPUBLIC  PORT=10031 HOST="&server"  SIGNER="http://&server:7980/SASLASRAuthorization" ;
